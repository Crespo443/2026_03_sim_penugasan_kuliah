    ...
    <div class="relative  ">
        <div class="hidden sm:block">
            <x-ui.input
                ...
                size="sm"
                class="input input-sm w-96 pr-8"
                x-model="query"
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-150"
            ...
            class="fixed inset-0  flex justify-center items-start mt-20 w-full z-50 sm:absolute sm:top-full sm:right-0 sm:left-auto mt-2 sm:w-96">
